const mostrar=()=> {
    ...
    ($date_three > totalTrabajador) ? (x = $text.textContent = `Los trabajadores ocupan el ${porcentajeSueldo}% de tu ganancia mensual que es de ${$date_three}`,
        $text.setAttribute("readonly", "")) : (x = $text.textContent = `No se puede hacer el cálculo porque la cantidad de trabajadores y su ganancia es mayor que el monto mensual`,
